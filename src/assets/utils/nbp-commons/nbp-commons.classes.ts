export enum NbpStyleClasse {
  ...
  DEFAULT_HOVER = 'npb-button-default-hover',
  PRIMARY = 'npb-button-primary',
  PRIMARY_HOVER = 'npb-button-primary-hover',
  SUCCESS = 'npb-button-success',
  ...
  OUTLINE_SUCCESS = 'npb-button-outline-success',
  OUTLINE_SUCCESS_HOVER = 'npb-button-outline-success-hover',
