...
@Component({
  selector: 'nbp-input-number',
  templateUrl: './nbp-input-number.component.html',
  styleUrls: ['./nbp-input-number.component.scss']
})
export class NbpInputNumberComponent extends NbpBaseComponent implements  OnInit {
  ...
  nbpGetClasses() {
    ...
    if(this.nbpErrorMessage) {
      this.nbpInputIcon = this.nbpInputIcon + this.nbpSeparator + "nbp-input-number-icon-message"
    }
