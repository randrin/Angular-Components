...
@Component({
  selector: 'nbp-dividing-line-three',
  templateUrl: './nbp-dividing-line-three.component.html',
  styleUrls: ['./nbp-dividing-line-three.component.scss']
})
export class NbpDividingLineThreeComponent extends NbpBaseComponent implements OnInit {
